...
function main {
    ...
    pip install -U scikit-image==0.17.2 opencv-python==4.8.0.74 opencv-python-headless==4.8.0.74
    ...
    do
        # cache
        python codes/MGANet_test_AI37.py --net_G ${CKPT_DIR} \
...
function generate_core_launcher {
    ...
    do
        ...
        printf "python -m oob-common.launch --enable_jemalloc \
            ...
            codes/MGANet_test_AI37.py --net_G ${CKPT_DIR} \
                --num_iter $num_iter --num_warmup $num_warmup \
                --precision $precision \
                --channels_last $channels_last \
                ${addtion_options} \
